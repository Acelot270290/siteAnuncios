...
$lang['upload_invalid_dimensions'] = 'A imagem que você está tentando fazer upload excede as dimensões máximas permitidas.<br>'.$CI->session->userdata('mensagem_upload');
