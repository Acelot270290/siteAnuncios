                      ...
                      <table class="table table-striped data-table">
                        ...
                        <tbody>
                          ...
                          <tr>
													...
													<td>
														 <a data-toggle='tooltip' data-placement='top' title="Editar usuário" href="<?php echo base_url('restrita/' .$this->router->fetch_class()  . '/core/' .$anuncio->anuncio_id ); ?>" class="btn btn-primary mr-2"><i class="fas fa-edit"></i></a>
														 <a data-toggle='tooltip' data-placement='top' title="Excluir usuário" href="<?php echo base_url('restrita/' .$this->router->fetch_class()  . '/delete/' .$anuncio->anuncio_id ); ?>" class="btn btn-danger delete" data-confirm="Tem certeza que deseja excluir?"><i class="fas fa-trash-alt"></i></a>
